...
<body id="fondoBlog">
	...
	<?php //Sanamos posibles errores de la paginación
		...
		foreach($tabla as $contenido){
			...
			echo "<div id='comentarios'style='width:400px'>";
	...
	<nav aria-label="Page navigation example">
		<ul class="pagination">
			<li class="page-item <?php echo $_GET['pagina']<=1? 'disabled':'' ?>"><a class="page-link" href="blog.php?pagina=<?php echo $_GET['pagina']-1 ?>">Anterior</a></li>

			<?php for ($i=0; $i < $paginas; $i++): ?>

			<li class="page-item <?php echo $_GET['pagina']==$i+1 ? 'active' : '' ?>"><a class="page-link" href="blog.php?pagina=<?php echo $i+1 ?>"><?php echo $i+1 ?></a></li>
			    <?php endfor ?>

			 <li class="page-item <?php echo $_GET['pagina']>=$paginas? 'disabled':'' ?>"><a class="page-link" href="blog.php?pagina=<?php echo $_GET['pagina']+1 ?>">Siguiente</a></li>
		</ul>
	</nav>
	<br>
