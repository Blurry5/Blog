...
<head>
	<meta charset="UTF-8">
	<meta http-equiv="Refresh" content="1, url=http://localhost/PHP/blog/usuario/foro.php?pagina=1">
...
<?php 
	...
	if($comentario != ''){
		$resultado = mysqli_query($conexion, 'INSERT INTO comentario(comentario,usuario) VALUES ("' . $comentario . '", "'. $_SESSION['id'] .'")');
